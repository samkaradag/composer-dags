...
initial_load_table2 = BigQueryOperator(
    ...
    sql=f'''
    #standardSQL
    SELECT *, CURRENT_DATETIME() AS start_date, DATETIME "9999-12-31 23:59:59"  AS end_date FROM `{PROJECT_ID}.{STAGING_DATASET}.table2`''', destination_dataset_table=f'{CURATED_DATASET}.table2',
    dag=dag)
